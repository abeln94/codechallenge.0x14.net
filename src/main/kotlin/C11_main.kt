...
private fun run(data: String) {
    // prepare output file
    File("C11_${data}_out.txt").printWriter().use { out ->
        // prepare input file
        File("C11_${data}_in.txt").bufferedReader().use { inp ->
 ...
 */
private tailrec fun List<String>.takeBestOfSize(size: Int, char: Int = 0): Pair<List<String>, Int> =
